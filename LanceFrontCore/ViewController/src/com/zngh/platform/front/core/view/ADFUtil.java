...
public class ADFUtil {
    ...
    public static ViewObject findViewObjectFromBindingIterator(String voIterator) {
        DCBindingContainer bc = (DCBindingContainer)getBindings();
        DCIteratorBinding iter = bc.findIteratorBinding(voIterator);
        return iter.getViewObject();
    }

    public static void setELExpressionValue(String elExpression, Object value) {
    ...
    public static Object resolveELExpressionValue(String elExpression) {
        FacesContext facesContext = FacesContext.getCurrentInstance();
    ...
    public static ApplicationModule getApplicationModuleForDataControl(String name) {
        return (ApplicationModule)resolveELExpressionValue("#{data." + name + ".dataProvider}");
    }
    ...
    public static BindingContainer getBindingContainer() {
        return (BindingContainer)resolveELExpressionValue("#{bindings}");
    }
    ...
    public static DCIteratorBinding findIterator(String bindingContainer, String iterator) {
        DCBindingContainer bindings = (DCBindingContainer)resolveELExpressionValue("#{" + bindingContainer + "}");
        if (bindings == null) {
    ...
    public static OperationBinding findOperation(String bindingContianer, String opName) {
        DCBindingContainer bindings = (DCBindingContainer)resolveELExpressionValue("#{" + bindingContianer + "}");
        if (bindings == null) {
