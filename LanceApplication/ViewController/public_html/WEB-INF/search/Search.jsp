        ...
        <div id="content" class="min-width" style="margin-top:0px;display:none;">
            <div class="left-list">
                ...
                <ul class="list-menu">
                    ...
                    <li>
                        <a href="#">IT &amp; Programming</a>
                    </li>
                    <li>
                        <a href="#">Design &amp; Multimedia</a>
                    </li>
                    <li>
                ...
                <ul class="list-menu">
                    <li class="sel">
                        <a href="#">All Freelancer Locations</a>
                    </li>
                    <li>
                        <a href="#">Country</a>
                    </li>
                    <li>
                        <a href="#">City, State or State</a>
                    </li>
                    <li>
                        <a href="#">ZIP</a>
                    </li>
                ...
                <ul class="list-menu">
                    <li class="sel">
                        <a href="#">Any Number of Reviews</a>
                    </li>
                    <li>
                        <a href="#">At least 5</a>
                    </li>
                    <li>
                        <a href="#">At least 10</a>
                    </li>
                    <li>
                        <a href="#">At least 15</a>
                    </li>
                </ul>
                <ul class="list-menu">
                    <li class="sel">
                        <a href="#">Any Hourly Rate</a>
                    </li>
                    <li>
                        <a href="#">Specific Hourly Rate</a>
                    </li>
                </ul>
                <ul class="list-menu">
                    <li class="sel">
                    ...
                    <li>
                        <a href="#">Selected Group</a>
                    </li>
                </ul>
            </div>
            <div class="right-list">
                <div class="all-count">
                    <span class="ntext chfont fb">All Freelances
                        <span class="ntext sml-font">(1456778 results)</span></span>
                </div>
                <div class="search-key">Results for 'html'</div>
                <div class="list-free">
                    <div class="mod temp_mod lancer">
                        <img src="/lance/resources/image/pic/download.jpg" alt="" width="64" height="64"
                             class="f-left avatar"/>
                        <div class="infor">
                            <div class="title">
                                ...
                                <span class="wlist-con">
                                    <span class="hire-icon-watch wlist"></span><a href="#" class="wlist">Add to Watch
                                                                                                         List</a><a class="btn-green"
                                                                                                                                 href="#">Hire
                                                                                                                                          me</a></span>
                            </div>
                            ...
                            <div class="jt">
                                ...
                                <span>IT &amp; Programming
                                    <a href="#" class="hire-icon-level">30</a></span>
                            ...
                            <div class="desc normal-text">Personalized world class Mobile and Web solutions for your
                                                          business. Proven expertise and dozens of successfully
                                                          completed projects. Over 52,000 worked hours on Marketplaces.
                                                          Agile software...</div>
                            <div class="bot-info">
                                <span class="hire-icon hicon-vedio"></span>
                    ...
                    <div class="mod temp_mod job">
                        <div class="infor chfont">
                            ...
                            <div class="desc normal-text">Personalized world class Mobile and Web solutions for your
                                                          ...
                                                          Agile software...</div>
                            <div class="bot-info">
                                <span class="normal-text s21">
                                    <span>Category:</span></span>
                                 
                                <span class="sep">&nbsp;&nbsp;|&nbsp;&nbsp;</span>
                                 
                                <span class="normal-text s22">
                            ...
                            <div class="btm">
                                <table border="0" class="normal-text chfont">
                                    <tr>
                                        <td class="fb">类型：</td>
                                        <td class="job-lx" style="width:150px;">XXX</td>
                                        <td class="fb">技能：</td>
                                        <td class="job-skill">
                                            <a href="#" class="btn-gray">IOS 6</a>
                                    ...
                                    <tr>
                                        <td class="fb">评级：</td>
                                        <td class="job-pj">XXX</td>
                                        <td class="fb">地点：</td>
                                        <td class="job-loc">XXX</td>
                                    </tr>
                                </table>
                            </div>
                        </div>
                ...
                <div class="pages-list">
                    <ul>
                        <li>
                            <a href="#">
                                <span>&laquo;</span>&nbsp;First</a>
                        </li>
                        <li>
                            <a href="#">
                                <span>&laquo;</span>&nbsp;Back</a>
                        </li>
                        <li>
                            <a href="#">1</a>
                        </li>
            ...
            <div class="oppor" style="display:none;">
                <h1>
                    We found some jobs you may like ...
                    <br/>
                    ...
                    <div class="choose">
                        ...
                        <div class="lists">
                            <ul>
                                ...
                                <li>
                                    <a href="#">Hiring Open</a>
                                </li>
                                <li>
                                    <a href="#">Selecting Candidate</a>
                                </li>
                                <li>
                                    <a href="#">Working</a>
                                </li>
                    ...
                    <div class="mod">
                        ...
                        <div class="mod-content">
                                ...
                                <div class="recomm">
                                    <div class="content">
                                        ...
                                        <div class="txt">
                                            ...
                                            <div class="preview">
                                                <p>
                                                    <span class="bt">Low</span>$<span class="squrt">&nbsp;</span>
                                                </p>
                                                <p>
                                                    <span class="bt">Avg</span>$<span class="squrt">&nbsp;</span>
                                                </p>
                                                <p>
                                                    <span class="bt">High</span>$<span class="squrt">&nbsp;</span>
                                                </p>
                                            </div>
                            ...
                            <div class="detail">
                                ...
                                <br/>
                                <p class="txt">
                                    We provide an online brain health tool that collects data using an online form, and
                                    then scores the user responses to create a customized report. We are currently
                                    trying a new *prototype* version of the test that provid.. 
                                ...
                                <div class="skills">
                                    ...
                                    <a href="#">Facebook Javascript (FBJS)</a>
                                </div>
                            </div>
                            <div class="buttons">
                ...
                <div class="right-infor f-right">
                    <div class="widget">
                        ...
                        <p class="normal-text">We'll send you jobs and clients in the following category:</p>
                        <span class="bold-text">IT &amp; Programming
                    ...
                    <div class="box-infor">
                        ...
                        <ul>
                            <li>
                                <img src="/lance/resources/image/lance/lightbulb.png" alt=""/><a href="#">How to Create
                                                                                                          a Great Profile</a>
                            </li>
                            <li>
                                <img src="/lance/resources/image/lance/lightbulb.png" alt=""/><a href="#">Making Every
                                                                                                          Proposal Count</a>
                            </li>
                            <li>
                                <img src="/lance/resources/image/lance/lightbulb.png" alt=""/><a href="#">7 Tips to Win
                                                                                                          More Jobs on
                                                                                                          Elance</a>
                            </li>
                            <li>
                                <img src="/lance/resources/image/lance/lightbulb.png" alt=""/><a href="#">Learn More
                                                                                                          From the
                                                                                                          official
                                                                                                          Freelancer
                                                                                                          Guide</a>
                            ...
                            <li>
                                <img src="/lance/resources/image/lance/lightbulb.png" alt=""/><a href="#">Attend a Free
                                                                                                          Webinar &amp;
                                                                                                          Learn More
                                                                                                          From the Pros</a>
                            </li>
