...
public class LanceRestAMImpl extends BaseApplicationModuleImpl {
     ...
     * @return
     */
    public ViewObjectImpl createDynamicViewObject(String viewName, String sql) {
        ViewObjectImpl vo = (ViewObjectImpl)this.findViewObject(viewName);
        if (vo != null) {
            vo.remove();
        }
        vo = (ViewObjectImpl)this.createViewObjectFromQueryStmt(viewName, sql);
        vo.executeQuery();
        vo.setRangeSize(-1);
        return vo;
    }
     ...
     */
    public BaseViewObjectImpl getContractReportVVO1() {
    ...
    /**
     * Container's getter for ContractReport2.
     * @return ContractReport2
     */
