...
public class UUserVORowImpl extends BaseViewRowImpl {
    ...
    public static final int USERWORKEXP = AttributesEnum.UserWorkExp.index();
    ...
    /**
     * Gets the associated <code>RowIterator</code> using master-detail link UserWorkExpComment.
     */
    public RowIterator getUserWorkExpComment() {
        return (RowIterator) getAttributeInternal(USERWORKEXPCOMMENT);
    }

    /**
     * Gets the associated <code>RowIterator</code> using master-detail link UserWorkExp.
     */
    public RowIterator getUserWorkExp() {
        return (RowIterator) getAttributeInternal(USERWORKEXP);
    }
